            ...
            for n in range(0, len(shifts)):
                ...
                if rand == 1:
                    ...
                    if schedule_check(testSchedule) and swap:
                        ...
                        print(testSchedule["PointValue"])
                        print(testSchedule["Mon"])
                        print(testSchedule["Tues"])
                        print(testSchedule["Wed"])
                        print(testSchedule["Thur"])
                        print(testSchedule["Fri"])
                        print(testSchedule["Sat"])
                        print(testSchedule["Sun"])
                        iterations += 1
                        errorCheck = 0
...
if __name__ == "__main__":
    ...
    print("Hello World!")
    genetic(copy.deepcopy(schedule))
